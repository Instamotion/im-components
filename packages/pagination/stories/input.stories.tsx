...
import Pagination, { InputProps } from '../src';
...
const TextInputValidationDemo = (): React.ReactElement => {
  ...
  return (
    <IntlProvider locale="de" messages={{}}>
      <div style={{ fontSize: '16px' }}>
        <Pagination {...requiredProps} />
        <Pagination {...minLengthProps} />
        <Pagination {...patternProps} />
        <Pagination {...emailProps} />
        <Pagination {...urlProps} />
        <Pagination {...numberProps} />
      </div>
    </IntlProvider>
  );
};
